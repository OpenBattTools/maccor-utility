...
Welcome to `maccor-utility` contributor's guide.
...
If you experience bugs or general issues with `maccor-utility`, please have a look
...
You can help improve `maccor-utility` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`maccor-utility` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `maccor-utility`'s files. While this mechanism can
...
```
conda create -n maccor-utility python=3 six virtualenv pytest pytest-cov
conda activate maccor-utility
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/maccor-utility.git
   cd maccor-utility
   ```
...
5. Install [pre-commit]:
   ...
   `maccor-utility` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/maccor-utility
[issue tracker]: https://github.com/<USERNAME>/maccor-utility/issues
